...
biología, especialmente la genética del desarrollo.
...
genética. Por esta razón, se pueden detectar tipos salvajes de este organismo 
y los experimentos son menos costosos, en comparación 
...
pesar de la utilidad del C. elegans para manipulaciones genéticas,
...
esqueletizaci\'on de las formas extra\'idas y parametrizaci\'on 
del contorno de los gusanos.\\ 

La esqueletizaci\'on y subsecuente parametrizaci\'on, se han convertido en un 
...
\item \textbf{Cap\'itulo 3: Dise\~no Metodol\'ogico}\\
  Se desarrolla el razonamiento que sustenta la soluci\'on propuesta.
  Seguidamente, la soluci\'on es presentada a manera de metodolog\'ia. Cada
  etapa incluida en la metodolog\'ia es explicada, justificando el enfoque
