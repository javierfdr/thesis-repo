...
El presente documento esta divido de la siguiente forma:
\begin{itemize}
...
\item \textbf{Cap\'itulo 3: Metodolog\'ia}\\
  La soluci\'on propuesta es razonada y presentada
  por etapas, como una metodolog\'ia. Luego, cada etapa es explicada, 
  desarrollando el enfoque particular y presentando los detalles de
  implementaci\'on relevantes.
