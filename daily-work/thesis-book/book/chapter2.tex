...
A skeleton is a compact and simple representation of an object that consists in a thin
...
Skeletons are important for object representation and recognition in diferent areas,
...
It consists in identifying the area or contour of a specifical
...
different types of shape descritors depending on the information
...
images. They allow image evidence to be organised into plausible interpretations
...
that attemp to describe a shape based on the geometrical and numerical properties
