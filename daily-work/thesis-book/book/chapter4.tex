...
\begin{figure}[htp]
  \begin{center}
    \subfloat[Image 1]{\label{fig:energy1b}\includegraphics[scale=0.5]{results/test1/energy-graph}} \\
    \subfloat[Image 2]{\label{fig:energy2b}\includegraphics[scale=0.5]{results/test2/energy-graph}} \\
    \subfloat[Image 3]{\label{fig:energy3b}\includegraphics[scale=0.5]{results/test3/energy-graph}}
  \end{center}
